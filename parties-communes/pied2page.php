<footer>
            ...
            <div class="contenu">
                ...
                <section class="apropos">
                    ...
                    <nav>
                        <a href="compagnie.com" class="faq"><?= $_pp ->aProposTitre ?></a>
                        <a href="equipe.php" class="livraison"><?= $_pp ->aProposCompagnie ?></a>
                        <a href="emploi.php" class="conditions"><?= $_pp ->aProposEquipe ?></a>
                    </nav>
                </section>
